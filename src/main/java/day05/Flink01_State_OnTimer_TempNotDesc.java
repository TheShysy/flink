...
public class Flink01_State_OnTimer_TempNotDesc {
    public static void main(String[] args) throws Exception {
        ...
        //读取端口数据宾馆转换为JavaBean
        SingleOutputStreamOperator<SensorReading> sensorDS = env.socketTextStream("hadoop102", 9999).map(new MapFunction<String, SensorReading>() {
            @Override
